...
{
    ReturnValue->Val->Integer = StdioBasePrintf(Parser, stdout, NULL, 0, (char*)Param[0]->Val->Pointer, (StdVararg*)Param[1]->Val->Pointer);
}
...
{
    ReturnValue->Val->Integer = StdioBasePrintf(Parser, (FILE*)Param[0]->Val->Pointer, NULL, 0, (char*)Param[1]->Val->Pointer, (StdVararg*)Param[2]->Val->Pointer);
}
...
{
    ReturnValue->Val->Integer = StdioBasePrintf(Parser, NULL, (char*)Param[0]->Val->Pointer, -1, (char*)Param[1]->Val->Pointer, (StdVararg*)Param[2]->Val->Pointer);
}

void StdioVsnprintf(struct ParseState *Parser, struct Value *ReturnValue, struct Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = StdioBasePrintf(Parser, NULL, (char*)Param[0]->Val->Pointer, Param[1]->Val->Integer, (char*)Param[2]->Val->Pointer, (StdVararg*)Param[3]->Val->Pointer);
}

void StdioVscanf(struct ParseState *Parser, struct Value *ReturnValue, struct Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = StdioBaseScanf(Parser, stdin, NULL, (char*)Param[0]->Val->Pointer, (StdVararg*)Param[1]->Val->Pointer);
}

void StdioVfscanf(struct ParseState *Parser, struct Value *ReturnValue, struct Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = StdioBaseScanf(Parser, (FILE*)Param[0]->Val->Pointer, NULL, (char*)Param[1]->Val->Pointer, (StdVararg*)Param[2]->Val->Pointer);
}

void StdioVsscanf(struct ParseState *Parser, struct Value *ReturnValue, struct Value **Param, int NumArgs)
{
    ReturnValue->Val->Integer = StdioBaseScanf(Parser, NULL, (char*)Param[0]->Val->Pointer, (char*)Param[1]->Val->Pointer, (StdVararg*)Param[2]->Val->Pointer);
}
