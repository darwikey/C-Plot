...
{
    ReturnValue->Val->Pointer = asctime((tm*)Param[0]->Val->Pointer);
}
...
{
    ReturnValue->Val->Pointer = ctime((time_t*)Param[0]->Val->Pointer);
}
...
{
    ReturnValue->Val->Integer = strftime((char*)Param[0]->Val->Pointer, Param[1]->Val->Integer, (char*)Param[2]->Val->Pointer, (tm*)Param[3]->Val->Pointer);
}
