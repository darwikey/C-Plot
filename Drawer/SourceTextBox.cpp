...
namespace tgui
{
	...
	SourceTextBox::SourceTextBox()
	{
		...
		m_renderer = std::make_shared<SourceTextBoxRenderer>(this);
		reload();
	...
	SourceTextBox::SourceTextBox(const SourceTextBox& scrollbarToCopy) :
	...
	SourceTextBox& SourceTextBox::operator= (const SourceTextBox& right)
	{
		if (this != &right)
		{
			SourceTextBox temp(right);
	...
	void SourceTextBox::setPosition(const Layout2d& position)
	{
	...
	sf::Vector2f SourceTextBox::getFullSize() const
	{
	...
	void SourceTextBox::setFont(const Font& font)
	{
		Widget::setFont(font);
	...
	void SourceTextBox::setScrollbar(Scrollbar::Ptr scrollbar)
	{
		m_scroll = scrollbar;
	...
	Scrollbar::Ptr SourceTextBox::getScrollbar()
	{
		return m_scroll;
	}
	...
	void SourceTextBox::setOpacity(float opacity)
	{
	...
	sf::Vector2f SourceTextBox::getWidgetOffset() const
	{
	...
	bool SourceTextBox::mouseOnWidget(float x, float y) const
	{
	...
	void SourceTextBox::leftMousePressed(float x, float y)
	{
	...
	void SourceTextBox::leftMouseReleased(float x, float y)
	{
	...
	void SourceTextBox::mouseMoved(float x, float y)
	{
		if (!m_mouseHover)
			mouseEnteredWidget();
	...
	void SourceTextBox::mouseWheelMoved(int delta, int, int)
	{
	...
	std::pair<std::size_t, std::size_t> SourceTextBox::findTextCaretPosition()
	{
	...
	void SourceTextBox::reload(const std::string& primary, const std::string& secondary, bool force)
	{
	...
	void SourceTextBoxRenderer::setProperty(std::string property, const std::string& value)
	{
	...
	void SourceTextBoxRenderer::setProperty(std::string property, ObjectConverter&& value)
	{
		property = toLower(property);
	...
	ObjectConverter SourceTextBoxRenderer::getProperty(std::string property) const
	{
		property = toLower(property);
	...
	std::map<std::string, ObjectConverter> SourceTextBoxRenderer::getPropertyValuePairs() const
	{
	...
	void SourceTextBoxRenderer::setBackgroundColor(const Color& color)
	{
	...
	void SourceTextBoxRenderer::setTextColor(const Color& color)
	{
		m_textColor = color;
	...
	void SourceTextBoxRenderer::setSelectedTextColor(const Color& color)
	{
	...
	void SourceTextBoxRenderer::setSelectedTextBackgroundColor(const Color& color)
	{
	...
	void SourceTextBoxRenderer::setBorderColor(const Color& borderColor)
	{
	...
	void SourceTextBoxRenderer::setCaretColor(const Color& caretColor)
	{
	...
	void SourceTextBoxRenderer::setCaretWidth(float width = 2)
	{
		m_caretWidth = width;
	}
	...
	void SourceTextBoxRenderer::setBackgroundTexture(const Texture& texture)
	{
	...
	void SourceTextBoxRenderer::setPadding(const Padding& padding)
	{
	...
	void SourceTextBoxRenderer::draw(sf::RenderTarget& target, sf::RenderStates states) const
	{
		// Draw the background
		if (m_backgroundTexture.isLoaded())
	...
	Padding SourceTextBoxRenderer::getScaledPadding() const
	{
	...
	std::shared_ptr<WidgetRenderer> SourceTextBoxRenderer::clone(Widget* widget)
	{
		auto renderer = std::make_shared<SourceTextBoxRenderer>(*this);
		renderer->m_textBox = static_cast<SourceTextBox*>(widget);
		return renderer;
	}
