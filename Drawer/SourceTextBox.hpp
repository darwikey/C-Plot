...
namespace tgui
{
	...
	///
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	class TGUI_API SourceTextBox : public Widget
	{
	public:

		typedef std::shared_ptr<SourceTextBox> Ptr; ///< Shared widget pointer
		typedef std::shared_ptr<const SourceTextBox> ConstPtr; ///< Shared constant widget pointer
		...
		///
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		SourceTextBox(const SourceTextBox& copy);
		...
		///
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		SourceTextBox& operator= (const SourceTextBox& right);
		...
		///
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		static SourceTextBox::Ptr create();


		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/// @brief Makes a copy of another text box
		///
		/// @param SourceTextBox  The other text box
		///
		/// @return The new text box
		///
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		static SourceTextBox::Ptr copy(SourceTextBox::ConstPtr SourceTextBox);
		...
		///
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		std::shared_ptr<SourceTextBoxRenderer> getRenderer() const
		{
			return std::static_pointer_cast<SourceTextBoxRenderer>(m_renderer);
		}
	...
	protected:
		...
		{
			return std::make_shared<SourceTextBox>(*this);
		}
	...
	protected:
		...
		friend class SourceTextBoxRenderer;
	...
	class TGUI_API SourceTextBoxRenderer : public WidgetRenderer, public WidgetBorders, public WidgetPadding
	{
	public:
		...
		///
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		SourceTextBoxRenderer(SourceTextBox* textBox) : m_textBox{ textBox } {}
